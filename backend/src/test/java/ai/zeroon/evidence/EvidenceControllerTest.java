...
class EvidenceControllerTest {
    ...
    void everyApprovedEventNameAcceptsOnlyItsReviewedTypedShape() throws Exception {
        ...
        List<EventCase> cases = List.of(
                ...
                new EventCase("RETURN_CUE_AVAILABLE",
                        "\"recordAgeBucket\":\"ONE_TO_SIX_DAYS\",\"surface\":\"NOW\""),
                new EventCase("RETURN_CUE_OPENED",
                        "\"recordAgeBucket\":\"ONE_TO_SIX_DAYS\",\"surface\":\"NOW\""),
                new EventCase("RETURN_CUE_DISMISSED",
                        "\"recordAgeBucket\":\"ONE_TO_SIX_DAYS\",\"surface\":\"NOW\""),
                new EventCase("RETURN_CUE_CONTINUED",
                        "\"recordAgeBucket\":\"ONE_TO_SIX_DAYS\",\"surface\":\"NOW\""),
